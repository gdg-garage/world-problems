...
["world_problems", "package:world_problems/world_problems.dart", , U, {
  ...
  WorldProblemsApp: {
    ...
    initialize$3: function(buttonId, firstId, thirdId) {
      ...
      this._reloadDiv = document.querySelector(".button");
      first = document.querySelector(firstId);
      second = document.querySelector(thirdId);
      this.page = new U.PageView(this.reload, U.ProblemView$(first), U.ProblemView$(second));
      t1 = J.get$onClick$x(this.reload);
...
function dart_precompiled($collectedClasses) {
  ...
  function WorldProblemsApp_initialize__closure(this_1) {
    this.this_1 = this_1;
  }
  WorldProblemsApp_initialize__closure.builtin$cls = "WorldProblemsApp_initialize__closure";
  if (!"name" in WorldProblemsApp_initialize__closure)
    WorldProblemsApp_initialize__closure.name = "WorldProblemsApp_initialize__closure";
  $desc = $collectedClasses.WorldProblemsApp_initialize__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WorldProblemsApp_initialize__closure.prototype = $desc;
