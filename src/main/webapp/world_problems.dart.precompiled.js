...
["world_problems", "package:world_problems/world_problems.dart", , U, {
  ...
  Fetcher: {
    "^": "Object;apiUrl",
    fetchRandom$1: function(ignore) {
      var completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      W.HttpRequest_getString(this.apiUrl, null, null).then$1(new U.Fetcher_fetchRandom_closure(this, completer));
      return completer.future;
    },
    fetchRandom$0: function() {
      return this.fetchRandom$1(null);
    }
  },
  Fetcher_fetchRandom_closure: {
    ...
    call$1: function(json) {
      ...
      t1 = C.JsonCodec_null_null.decode$1(json);
      t2 = J.getInterceptor$asx(t1);
  ...
  WorldProblemsApp: {
    "^": "Object;fetcher,page,isInitialize,problemsHistory",
    ...
    getRandomPair$0: function() {
      var t1 = this.fetcher;
      t1.fetchRandom$1(this.problemsHistory).then$1(new U.WorldProblemsApp_getRandomPair_closure(this));
      return t1.fetchRandom$0();
    }
  },
  ...
  WorldProblemsApp_getRandomPair_closure: {
    ...
    call$1: function(pair) {
      var t1 = this.this_0;
      t1.problemsHistory._add$1(pair.get$firstProblem());
      t1.problemsHistory._add$1(pair.thirdProblem);
      return pair;
    }
  }
}],
["", "world_problems.dart", , N, {
  "^": "",
  main: [function() {
    var app = new U.WorldProblemsApp(new U.Fetcher("/_ah/api/problems/v1/random"), null, null, null);
    app.isInitialize = false;
    app.problemsHistory = P.ListQueue$(null, null);
    app.initialize$3("#reload-button", ".first-world", ".third-world");
    if (!app.isInitialize)
      H.throwExpression(P.Exception_Exception("Worl problems not initialized"));
    app.refreshPair$0();
...
function dart_precompiled($collectedClasses) {
  ...
  function WorldProblemsApp(fetcher, page, isInitialize, problemsHistory) {
